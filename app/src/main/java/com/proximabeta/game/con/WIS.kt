...
import com.proximabeta.game.con.ThatClass.Companion.link
import com.proximabeta.game.con.databinding.ActivityWisBinding
...
class WIS : AppCompatActivity() {
    ...
    lateinit var hrfghrdssxc: ActivityWisBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        hrfghrdssxc = ActivityWisBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun urururururururur(): String {
        ...
        val pack = "com.proximabeta.game.con"
